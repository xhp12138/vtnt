import { Vue, Component, Prop, Mixins, Watch, Model } from "vue-property-decorator";
...
export default class vtntUpload extends Mixins(styleMixin) {
    b: any = this.b('vtnt-upload')
    @Model('input', { type: Array, default() { return [] } }) readonly fileList!: Array<any>
    @Prop({
        type: Function
    })
